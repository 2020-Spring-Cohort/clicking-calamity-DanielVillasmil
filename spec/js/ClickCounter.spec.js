describe('Clicking calamity Tests:', () => {
    ...
    describe('Clicking Companions:', () => {
        ...
        it('ClickCount should buy more clicking companions every 100 clicks.', () => {
            for (let i = 0; i < 220; i++) {
                underTest.countClick()
            }
            underTest.purchaseCompanion()
        ...
        it('click companion goes up by 10% after every purchase.', () => {
            for (let i = 0; i < 100; i++) {
                underTest.countClick()
            }
            underTest.purchaseCompanion()
        ...
        it('Click count should decrease by the cost of companion is bought.', () => {
            for (let i = 0; i < 101; i++) {
                underTest.countClick();
            }
            underTest.purchaseCompanion()
        ...
        it('click count should decrease by 100 after companion is bought.', () => {
            for (let i = 0; i < 110; i++) {
                underTest.countClick();
            }
            underTest.purchaseCompanion()
